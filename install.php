...
class Config
{
    ...
    // подготовим запросы для создания новых таблиц
        ...
        $constants = "CREATE TABLE IF NOT EXISTS constants (
    ...
    $dt = time(); // текущая метка времени
        ...
        $addLanguageRu = "insert into
						...
						VALUES('ru','русский','1','1')";
                    
        $addLanguageEn = "insert into
						languages(language,title,visible,default_lng)
        ...
        $addmenuRu = "insert into
        			...
        			VALUES('1','Мы предлагаем','1','ru','{$dt}','1','1')";
		
		$addmenuEn = "insert into
					menus(id,menu_name,position,language,created,visible,header_visible)
        			VALUES('2','We offer','2','en','{$dt}','1','1')";
